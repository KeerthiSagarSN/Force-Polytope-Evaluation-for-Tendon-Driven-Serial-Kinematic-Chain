...
syms theta_a theta_b X Y qc1 qc2 qc3 
...
q2= sqrt((-h2+ra1*Ca+s11*Sa)^2+(-m2+ra1*Sa-s11*Ca)^2);
q3= sqrt((u1+ra1*Ca-s5*Sa)^2+(-p1+ra1*Sa+s5*Ca)^2);
...
save('CN_cable3internalroutingSPwithbundling.mat')