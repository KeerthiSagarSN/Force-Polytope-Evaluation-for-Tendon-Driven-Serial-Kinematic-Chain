%% Generate a 2D Zonotope based on the 2D Generator points
% Each column of the matrix is a generator
% Input: G : Matrix - 2xN , N - Number of generator points, 1- row - all x
% values, and 2- row- all y values.. 
% Enjoy !!!

%function zonotype_2d_gen(G) 
