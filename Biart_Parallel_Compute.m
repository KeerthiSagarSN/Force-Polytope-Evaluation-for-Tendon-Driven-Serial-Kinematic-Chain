...
parfor teta_a = 1:110   
        for teta_b = 1:150
        teta_a;
        M(teta_a,teta_b),CN(teta_a,teta_b) = parfor_for(teta_a,teta_b,Ke);
...
save('CN_Biart.mat','M','CN')



function [M_fn,CN_fn] = parfor_for(teta_a,teta_b,Ke)
        L1=0.315; L2=0.234;
        r_a=0.2;
        r_b=0.1;
        L1=0.315; L2=0.234;
        ...
        j = L1*sind(teta_a)+L2*sind(teta_a+teta_b);
